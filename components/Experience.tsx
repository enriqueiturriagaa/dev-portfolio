    ...
    return (
        <div className='max-w-5xl m-auto px-4 lg:px-0 py-20 font-roboto'>
            ...
            {experiences.map((experience) => (
                <div className='bg-gradient-to-r-lg from-indigo-800 to-indigo-900 shadow-lg rounded-sm mb-6'>
                    <div className=' rounded-sm p-10 lg:flex lg:space-x-10 bg-gradient-to-r from-indigo-800 to-black'>
                        {/* Left */}
                        <div className='mb-5 lg-mb-0 lg:w-3/4'>
